...
if __name__ == "__main__":
    # 测试计算 pcap 统计信息
    pcapPath = r"E:/pythonProject/TrafficClassificationPandemonium-neww/TrafficClassificationPandemonium-main/M_pcap_flow_dir/Malicious/BrowserHijacking_fixed.pcap.HostPair_13-225-189-194_192-168-137-102.pcap"
    featuresCalc = FeaturesCalc(min_window_size=1) # 初始化
    pkts = rdpcap(pcapPath, count=1) # 一整个文件中有多个pcap文件, 读取之后会是一个list
    print(len(pkts))
    #print(pkts)
    #print(pkts[0].show())
